...
public final class DimensionImpl implements Dimension, Serializable {
    ...
    public Map<Dimension, Integer> getProductDimensions() {
        ...
        for (Entry<? extends Unit<?>, Integer> entry : pseudoUnits.entrySet()) {
            fundamentalDimensions.put(new DimensionImpl(entry.getKey()), entry.getValue());
        }
    ...
    public boolean equals(Object that) {
        if (this == that)
            return true;
        return (that instanceof DimensionImpl) && pseudoUnit.equals(((DimensionImpl) that).pseudoUnit);
    }
     ...
     * and {@linkplain DimensionImpl dimensions}. Custom models may allow
    ...
    public interface Model {
        ...
        public Model STANDARD = new Model() {
            ...
            public Dimension getDimension(Unit<?> unit) {
                ...
                return new DimensionImpl(new BaseUnit<Dimensionless>("[" + unit.getSymbol() + "]"));
            }
