...
import org.unitsofmeasurement.quantity.Substance;
 ...
 */
public class SubstanceAmount extends BaseAmount<Substance> {
	
	public SubstanceAmount(Number number, Unit<Substance> unit) {
		super(number, unit);
	}
}
